...
import com.example.junit5.springbootapp.service.BirthdayServiceImpl;
...
class BirthdayInfoControllerIT {
    ...
    private String bd1 = LocalDate.of(1979, 7, 14).format(DateTimeFormatter.ISO_DATE);
    private String bd2 = LocalDate.of(2018, 1, 23).format(DateTimeFormatter.ISO_DATE);
    private String bd3 = LocalDate.of(1972, 3, 17).format(DateTimeFormatter.ISO_DATE);
    private String bd4 = LocalDate.of(1945, 12, 2).format(DateTimeFormatter.ISO_DATE);
    private String bd5 = LocalDate.of(2003, 8, 4).format(DateTimeFormatter.ISO_DATE);
    ...
    @Test
    void testGetBirthdayChineseSign() throws Exception {
    ...
    @Test
    void testGetBirthdaytestStarSign() throws Exception {
    ...
    private void testDOW(String birthday, String dow) throws Exception {
        MvcResult result;
        result = mockMvc.perform(MockMvcRequestBuilders.post("/birthday/dayOfWeek")
